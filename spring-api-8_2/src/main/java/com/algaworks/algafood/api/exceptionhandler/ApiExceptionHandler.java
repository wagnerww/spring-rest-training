...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleInvalidFormatException(InvalidFormatException ex, HttpHeaders headers,
		...
		ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
		String detail = String.format(
				"A propriedade de '%s' recebeu o valor '%s', "
						+ "que é de um tipo inválido. Corrija e informe um valor compatível como tipo %s.",
	...
	public ResponseEntity<?> handleTratarEntidadeNaoEncontradoException(EntidadeNaoEncontradaException ex,
			WebRequest request) {
	...
	public ResponseEntity<?> handleTratarEntidadeNaoEncontradoException(EntidadeEmUsoException ex, WebRequest request) {
	...
	public ResponseEntity<?> handleTratarNegocioException(EntidadeEmUsoException ex, WebRequest request) {
